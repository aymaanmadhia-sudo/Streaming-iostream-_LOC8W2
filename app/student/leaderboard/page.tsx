  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-400">Rankings by judge scores (from Supabase)</p>
      </div>
                  ...
                  >
                    <td className="px-4 py-3">
                      {s.rank <= 3 ? (
                        ...
                        <span className="font-semibold text-slate-400">{s.rank}</span>
                      )}
                    </td>
                    <td className="px-4 py-3 font-medium text-white">{s.title}</td>
                    <td className="px-4 py-3 text-slate-400">{s.avgScore ?? "—"}</td>
